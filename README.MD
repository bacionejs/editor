...
- **Themes**: The editor offers both light and dark themes for a customizable viewing experience. You can toggle between themes by swiping up on the miscellaneous button. You can also easily change or add more themes by editing the editor.
