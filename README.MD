...
- **Keyboard Size Issue**: When opening the editor on a tablet, the keyboard may appear at the wrong size. If this happens, please refresh the page to adjust the keyboard to the correct size.  
