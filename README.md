...
IDE with a fully `custom keyboard` and the [only](//github.com/search?q=serverless+javascript+ide+language%3Ahtml&type=repositories) `serverless JavaScript` IDE.  

These features reduce editing frustrating, simplify installation, and enable rapid enhancements.
