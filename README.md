...
## Unique
BacioneJS is the only IDE with a fully [custom keyboard](//github.com/search?q=ide+%22custom+keyboard%22&type=repositories) and the only [standalone JavaScript](//github.com/search?q=standalone+javascript+ide+language%3Ahtml&type=repositories) IDE. These features reduce editing frustrating, simplify installation, and enable rapid enhancements.
